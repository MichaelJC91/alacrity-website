...
exports.default = colHeight;
//Get height of 1st column
function colHeight() {
  var colHeight = $('.contactFirstCol').height();
  $('#googleMap').css('height', colHeight + 'px');
}
...
exports.default = function () {
  ...
  if ((0, _jquery2.default)('header').offset().top > 0) {
    ...
    (0, _jquery2.default)('header').addClass('sticky');
    (0, _jquery2.default)('.logo').hide('slow');
    (0, _jquery2.default)('.fixedLogo').show('slow');
  }
};
...
exports.default = function () {
  ...
  if (windowSize <= mobileSize) {
    ...
    (0, _jquery2.default)('.logo').hide('slow');
    (0, _jquery2.default)('.fixedLogo').show('slow');
    (0, _jquery2.default)('.navbar-nav').addClass('mr-auto');
    (0, _jquery2.default)('.contactFormWrapper').removeClass('justify-content-between').addClass('justify-content-center');
    (0, _jquery2.default)('.topPadding50').removeClass('topPadding50').addClass('topPadding20');
  } else {
    ...
    (0, _jquery2.default)(window).scroll(function () {
      ...
      if (scroll && windowSize > mobileSize) {
        ...
        (0, _jquery2.default)('header').removeClass('sticky').addClass('transparentBackground');
        (0, _jquery2.default)('.fixedLogo').hide('slow');
        (0, _jquery2.default)('.logo').show('slow');
      }
    });
  }
};
...
function setNavigation() {
  ...
  (0, _jquery2.default)('.nav a').each(function (link) {
    var href = (0, _jquery2.default)(this).attr('href');
    if (href === path) {
      (0, _jquery2.default)(this).addClass('activeNavLink');
    }
  });
}
...
exports.default = toggleFunction;
...
function toggleFunction(target) {
  (0, _jquery2.default)(target + ' a').click(function () {
    if ((0, _jquery2.default)(target).hasClass('notActive')) {
      (0, _jquery2.default)(target).removeClass('notActive').addClass('activeToggle');
    } else {
      (0, _jquery2.default)(target).removeClass('activeToggle').addClass('notActive');
    }
  });
}
...
var _columnHeights = __webpack_require__(1);
...
exports.default = (0, _jquery2.default)(document).ready(function () {
  ...
  (0, _setNavigation2.default)();

  // Check if page width is > 990px
  // If not then make col heights the same
  if ((0, _jquery2.default)(window).width() > 990) {
    (0, _columnHeights2.default)();
  } else {
    (0, _jquery2.default)('#googleMap').css('height', '400px');
  }
  ...
  (0, _toggleFunction2.default)('.homeBenefitsTwo');
  (0, _toggleFunction2.default)('.homeBenefitsThree');
  ...
  //Testimonial Slider
  (0, _jquery2.default)('.testimonials').slick({
    autoplay: true,
    autoplaySpeed: 3000,
    arrows: false,
    dots: true,
